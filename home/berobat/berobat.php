		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7 align-self-center text-lg-left text-center">
					<h1 class="mb-0 mt-4 display-4">Klinik UPB (Berobat)</h1>
				</div>
				<div class="col-lg-5 p-3" id="book">
					<?php
						...
						$dataPasien	= mysqli_query($koneksi, $stringPasien);
						$arrayPasien = mysqli_fetch_array($dataPasien);

						// Data Dokter
						$stringDokter = "SELECT * FROM dokter order by id_dokter DESC";
						$dataDokter	= mysqli_query($koneksi, $stringDokter);
						$arrayDokter = mysqli_fetch_array($dataDokter);
					?>
						<form enctype="multipart/form-data" class="p-4 section-light bg-light" method="POST" action="add_berobat.php">
							<h4 class="mb-3 text-center">Input Data Berobat</h4>

							<div class="form-group">
								<label for="pasienLabel">Pasien</label>
								<select class="form-control" id="pasienLabel" name="idPasien">
							...
							<div class="form-group">
								<label for="DokterLabel">Dokter</label>
								<select class="form-control" id="DokterLabel" name="idDokter">
							...
							<div class="form-group">
								...
								<select class="form-control" id="penatalaksanaan" name="penatalaksanaan">
							...
							<a href="berobat.php#menu" class="btn btn-default"> <i class="fa fa-times"></i><class="btn btn-primary">Discard</a>
						</form></div>
				</div>
			</div>
		</div>
				...
				<table id="cari" class="table">
					<thead>
						...
						<tbody>
							...
							$sql = "SELECT * FROM berobat a JOIN pasien b ON a.id_pasien=b.id_pasien JOIN dokter c ON a.id_dokter=c.id_dokter";
