<?php
	...
	include ("../../koneksi.php");
	$key = mysqli_real_escape_string($koneksi,$_GET['id_obat']);

	$view_sp = mysqli_query($koneksi,"SELECT * FROM obat WHERE id_obat='".$key."'");
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7 align-self-center text-lg-left text-center">
					<h1 class="mb-0 mt-4 display-4">Klinik UPB (Edit Obat)</h1>
				</div>
				<div class="col-lg-5 p-3" id="book">
					<form class="p-4 section-light bg-light" method="POST" name="exc" action="updateObat.php?q=<?php echo $key ; ?>">
						<h4 class="mb-3 text-center">Edit Obat</h4>
						<div class="form-group"> <label>Id Obat</label>
							<input class="form-control" placeholder="Type here" name="textid" disabled="" value="<?php echo $call_sp['id_obat'] ; ?>"> </div>
							<div class="form-group"><label>Nama Obat</label>
							<input type="text" class="form-control" name="textnama" id="textnama"  value="<?php echo $call_sp['nama_obat']; ?>"></td></div>
