		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7 align-self-center text-lg-left text-center">
					<h1 class="mb-0 mt-4 display-4">Klinik UPB (Tambah Obat)</h1>
				</div>
				<div class="col-lg-5 p-3" id="book">
					<?php
					$s = "SELECT id_obat FROM obat order by id_obat desc limit 1";
...
?>
						<form enctype="multipart/form-data" class="p-4 section-light bg-light" method="POST" action="add_obat.php">
							<h4 class="mb-3 text-center">Input Data Obat</h4>
					<div class="form-group"><label>Id Obat</label>
						...
						<input type="hidden" class="form-control" placeholder="Type here" name="textid" value="<?php echo $c; ?>" >
							...
							<a href="obat.php#menu" class="btn btn-default"> <i class="fa fa-times"></i><class="btn btn-primary">Discard</a>
						</form></div>
				</div>
			</div>
		</div>
...
$no =$mulai+1;
						...
						<td>
							<a class='btn navbar-btn btn-success ' href='edit_obat.php?id_obat=".$data['id_obat']."'>Edit</a>
							<a class='btn navbar-btn btn-primary' href='hapus_obat.php?id_obat=$data[id_obat]' onclick=\"return confirm('Yakin data $data[nama_obat] akan dihapus ??')\">Delete</a></td>
						</tr>";
							$no++;
						}
						...
						<div class="menu">
						<ul>
						<p><button><li><a href="excel_obat.php" target="_blank">REPORT EXCEL</a></li></button></p>
						<ul></div>
