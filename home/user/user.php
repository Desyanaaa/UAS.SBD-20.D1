		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-5 p-3" id="book">
						<form enctype="multipart/form-data" class="p-4 section-light bg-light" method="POST" action="add_user.php">
              ...
              <div class="form-group">
								...
								<input type="text" class="form-control" placeholder="Type here" name="namaLengkap" required>
							</div>
              <br>
							<div class="form-group">
...
$no =$mulai+1;
            ...
            <td>
              <a class='btn navbar-btn btn-success ' href='edit_user.php?id_user=".$data['id']."'>Edit</a>
              <a class='btn navbar-btn btn-primary' href='hapus_user.php?id_user=$data[id]' onclick=\"return confirm('Yakin data $data[username] akan dihapus ??')\">Delete</a>
            </td>
            </tr>";
              $no++;
            }
