		...
		<div class="container">
			<div class="row">
				<div class="col-lg-7 align-self-center text-lg-left text-center">
					<h1 class="mb-0 mt-4 display-4">Klinik UPB (Tambah Pasien)</h1>
				</div>
				<div class="col-lg-5 p-3" id="book">
					<?php
					$s = "SELECT id_pasien FROM pasien order by id_pasien desc limit 1";
...
?>
						<form enctype="multipart/form-data" class="p-4 section-light bg-light" method="POST" action="add_pasien.php">
							<h4 class="mb-3 text-center">Input Data Pasien</h4>
							<input type="hidden" class="form-control" placeholder="Type here" name="textid" value="<?php echo $c; ?>" >

							<div class="form-group">
								<label>Id Pasien</label>
								<input type="text" disabled="" class="form-control" placeholder="Type here" value="<?php echo $c; ?>" >
							</div>
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" placeholder="Type here" name="textnama">
							</div>
							<br>
							<div class="form-group">
							...
							<div class="form-group">
								<label>Umur</label>
								<input required type="number" class="form-control" placeholder="100" name="umur" id="umur">
							</div>
...
$no =$mulai+1;
						...
						<td>$data[umur]</td>
						<td>
							<a class='btn navbar-btn btn-success ' href='edit_pasien.php?id_pasien=".$data['id_pasien']."'>Edit</a>
							<a class='btn navbar-btn btn-primary' href='hapus_pasien.php?id_pasien=$data[id_pasien]' onclick=\"return confirm('Yakin data $data[nama_pasien] akan dihapus ??')\">Delete</a>
						</td>
						</tr>";
							$no++;
						}
						...
						<div class="menu">
						<ul>
						<p><button><li><a href="excel_pasien.php" target="_blank">REPORT EXCEL</a></li></button></p>
						<ul></div>
